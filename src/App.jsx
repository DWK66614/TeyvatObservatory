  ...
  return (
    <div className="min-h-screen flex" style={{ background: c.bg }}>
      ...
      <div className="flex-1 flex flex-col min-h-screen lg:ml-64 pt-14 lg:pt-0">
        ...
        {/* Footer */}
        <footer className="border-t py-4 text-center relative z-10" style={{ borderColor: c.footerBorder }}>
          <p className="text-[10px]" style={{ color: c.footerText }}>
            提瓦特观测台 · 数据来源{' '}
            <a href="https://enka.network" target="_blank" rel="noopener noreferrer"
               className="hover:text-starlight transition-colors" style={{ color: c.footerLink }}>
              Enka.Network
            </a>{' '}
            · 仅供学习交流
          </p>
