            ...
            <div className="flex items-center gap-2 mt-1 flex-wrap">
              ...
              {character.constellations > 0 && (
                <span className="inline-flex items-center gap-0.5 text-[10px] font-mono font-bold px-1.5 py-0.5 rounded"
                      style={{
                        background: 'linear-gradient(135deg, rgba(237,217,163,0.12), rgba(224,184,64,0.08))',
                        color: '#edd9a3',
                        border: '1px solid rgba(237,217,163,0.15)',
                      }}>
        ...
        <div className="flex items-center gap-3 mt-3">
            ...
            <div className="flex items-center gap-1.5">
              {character.talentLevels.map((t, i) => (
                <span key={i} className="inline-flex items-center gap-0.5 text-[10px] font-mono px-1.5 py-0.5 rounded"
                      style={{ background: 'rgba(112,149,196,0.06)', color: '#8b8aa6' }}>
                  <span style={{ color: '#c0bdb5' }}>{t.label}</span>
                  <span style={{ color: '#edd9a3' }}>{t.level}</span>
                  {t.extra > 0 && (
                    <span style={{ color: '#40c9a0', fontSize: '8px' }}>+{t.extra}</span>
                  )}
                </span>
              ))}
            </div>
          ...
          {character.friendship > 0 && (
            <div className="flex items-center gap-1 text-[10px]"
                 style={{ color: character.friendship >= 10 ? '#e0554a' : '#8b8aa6' }}>
              <Heart className="w-3 h-3" style={{
                fill: character.friendship >= 10 ? '#e0554a' : 'transparent',
                color: character.friendship >= 10 ? '#e0554a' : '#8b8aa6',
              }} />
